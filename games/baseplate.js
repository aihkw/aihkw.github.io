...
class InputController {
  ...
  initialize_() {
    ...
    this.target_.addEventListener('mousemove', (e) => {this.onMouseMove_(e); console.log(e.movementX)}, false);
  ...
  onMouseMove_(e) {
    this.current_.mouseX = e.movementX + this.current_.mouseX //window.innerWidth;
    this.current_.mouseY = e.movementY + this.current_.mouseY //window.innerHeight;
...
class FirstPersonCameraDemo {
  ...
  initializeRenderer_() {
    ...
    this.threejs_.domElement.addEventListener("click", async () => {
      await this.threejs_.domElement.requestPointerLock();
      this.threejs_.domElement.requestFullscreen();
    });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  alert('Click to enter Full Screen')
});