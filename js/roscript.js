const parent = document.getElementById('roscripts');
fetch('/api/roscript.json')
...
.then(data => {
    data.forEach(item => {
        ...
        codeblock.classList.add('lang-lua');
        let copy = document.createElement('button');
        copy.innerHTML = '📋'
        copy.setAttribute('onclick', `c(this, "${item.code}")`)
